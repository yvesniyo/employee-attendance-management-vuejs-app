  ...
  <div class="row">
    <div class="col-md-12 p-0">
      <div class="md-layout bg-white mt-3">
        ...
        <div class="md-layout-item md-size-20 pt-4 pr-3 text-left">
          <md-button
            class="m-0 mr-1 text-info text-capitalize"
    ...
    <div class="col-md-12 p-0">
      <div class="md-layout bg-white mt-3 pb-3">
        <div class="md-layout-item md-size-20 pt-3">
          <md-avatar class="">
            <md-icon>account_balance_wallet</md-icon>
          </md-avatar>
        </div>
        <div class="md-layout-item md-size-30 pt-4 text-left">
          <label class="text-dark d-block">Wallet</label>
        </div>
        <div class="md-layout-item md-caption md-size-40 pt-4">
          {{ moneyFormat(user.wallet.balance) }} Rwf
        </div>
      </div>
      <div class="md-layout bg-white border-top pb-3">
        ...
        <div class="md-layout-item md-size-30 pt-4 text-left">
          <label class="text-dark d-block">{{ $t("Points") }}</label>
        </div>
        <div class="md-layout-item md-caption md-size-40 pt-4">
          {{ user.points }}
        </div>
      ...
      <div class="md-layout bg-white border-top pb-3">
        ...
        <div class="md-layout-item md-size-30 pt-4 text-left">
          <label class="text-dark">{{ $t("Code") }}</label>
          <span
            @click="generateNewCode()"
            class="el-link text-monospace ml-3 text-warning"
            >New</span
          >
        </div>
        <div class="md-layout-item md-caption md-size-40 pt-4">
    ...
    <div class="col-md-12 p-0">
      <div class="md-layout bg-white mt-3 pb-3">
        ...
        <div class="md-layout-item md-size-80 pt-4 text-left">
          <label class="text-dark d-block">{{ $t("Refer and Earn") }}</label>
        </div>
      </div>
      <div class="md-layout bg-white border-top pb-3">
        <div class="md-layout-item md-size-20 pt-3">
