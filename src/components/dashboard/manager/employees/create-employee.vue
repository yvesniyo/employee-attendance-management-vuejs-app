  ...
  <div class="row p-5">
    <div class="col-md-12 p-0">
      <md-app-toolbar class="border-0">
        <span class="md-title"> {{ $t("Create Employee") }} </span>
      </md-app-toolbar>
    </div>
      ...
      <form @submit.prevent="saveEmployee">
        ...
        <md-field :class="{ 'md-invalid': valid.employee.national_id }">
          ...
          <md-input
            ...
            type="text"
            autocomplete="none"
            v-model="form.employee.national_id"
            :disabled="sending"
          />
    ...
    saveEmployee: function () {
      ...
      this.createEmployee(this.form.employee)
        .then((response) => {
          ...
          ctx.clearForm();
          ctx.employeeCreateResponse = "Employee created successfully";
